...
// No admin username/password needed - using Entra ID authentication only
...
resource billingDatabase 'Microsoft.DBforPostgreSQL/flexibleServers/databases@2025-01-01-preview' = {
  parent: postgres
  name: 'billing'
  properties: {
    charset: 'UTF8'
...
// This satisfies the policy requirement for Entra ID authentication
...
output databaseName string = billingDatabase.name
